...
public class ConstructorMockIntention extends PsiElementBaseIntentionAction {
     ...
     */
    protected void handleCommand(@NotNull PsiElement scope, @Nullable ParameterList parameterList, @NotNull Method method, @NotNull NewExpression newExpression, @NotNull Editor editor) {
